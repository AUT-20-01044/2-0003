...
#define NVS_KEY_WIFI_PASS "wifipass"   //string
#define NVS_KEY_USER_ID "userid"       //string
#define NVS_KEY_DEVICE_ID "deviceid"   //string
#define NVS_KEY_USER_EMAIL "useremail" //string
